...
<?php
    ...
    $dbc = mysqli_connect($servername, $username, $password, $basename) or die("Error connecting to database");
    mysqli_set_charset($dbc, "utf8");

    $query = "SELECT * FROM vijesti WHERE kategorija = 'Kupovi Hrvatske vatrogasne zajednice' AND arhiva = 0 ORDER BY id DESC";
